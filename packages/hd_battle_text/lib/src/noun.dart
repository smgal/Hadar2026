/// 명사 + 위치별 조사 묶음.
///
/// `hadar2026_app/lib/domain/text/noun.dart` 에서 그대로 옮겨 왔다.
/// **조사 처리는 문장의 일이다** — `hd_battle` 은 문장을 만들지 않고
/// 구조화된 `BattleEvent` 만 낸다. 그래서 model 바깥에 있고,
/// 콘솔과 Flutter view 가 같은 것을 쓴다.
///
