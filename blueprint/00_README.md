...
| [BP-44](44_bestiary.md) | **적·아군 명세 — type → 계열 → 개체 · 역할·등급·용맹 · 직업 17 과 preset** (2026-09-06 2차 초안) |
| [BP-45](45_party_weapons.md) | **아군 무기 분화 — 손 구성 → 무기 종류 13 · 사거리·고유 동작 · 슬롯 규칙** (2026-09-06 초안) |
| [BP-46](46_preset_logic.md) | **자동 전투의 판단 규칙 — preset 7 + 절약이 매 라운드 고르는 것 · 무기 보정 · 리더 대열 판단** (2026-09-06 초안) |
| [BP-47](47_equipment_and_traversal.md) | **장비 슬롯 여덟 · 횃불과 밝기 · 통행 능력 셋의 장비화 · 세계 진행 게이트** (2026-09-07 초안) |
