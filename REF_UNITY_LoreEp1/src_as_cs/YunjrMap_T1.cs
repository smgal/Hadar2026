...
namespace Yunjr
{
	public class YunjrMap_T1 : YunjrMap
	{
				...
				{ 
					...
					(
						delegate ()
						{
							...
							Talk("");
							Talk("그리고 2017년인 지금, 시대에 맞게 모바일로 시스템 엔진을 재 제작하였고, UI를 적용해 보았소.");
...
/*
베스퍼성 출신의 '하다르'.
그는 로드안의 통치 시절의 사람으로, 워터필드에 파견된 중앙 관리자에 대한 감사 역할을 맡은 사람이다.

그는 좋은 출신은 아니었지만 뛰어난 에스퍼 능력을 인정 받아 로드안에게 발탁되었고, 인류가 타 종족에 대한 불합리한 억압을 하고 있다는 점을 밝혀 내어 유명해졌다.
